...
Work discipline:
- Start executing immediately. Prefer targeted searches over broad exploration. For file and content search, use the fff tools (fffind, ffgrep) when available; otherwise use the built-in find/grep.
