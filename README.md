...
├── README.md                    # 你在这里
├── docs/
│   ├── 01-理念与路线.md          # 三缺口、三理念、阶段划分逻辑
│   ├── 02-基础阶段.md            # 联网、命名
│   ├── 03-进阶阶段.md            # fff、压缩、观测、提问
│   ├── 04-高阶阶段.md            # 子代理、剪枝
│   ├── 05-界面与观测.md          # UI 美化、速度仪表
│   ├── 06-settings.md           # settings.json 逐块注释
│   ├── 07-models.md             # 模型、思考档位映射
│   ├── 08-agents.md             # fast 子代理设计
│   └── 09-agents-md.md          # AGENTS.md 全局指令
├── plugins/
